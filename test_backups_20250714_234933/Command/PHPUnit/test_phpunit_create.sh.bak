...
run_test_step "Créer un test simple" \
    "$PROJECT_ROOT/bin/psysh -c \"phpunit:create 'App\\\\Service\\\\TestService'\"" \
    "✅" \
    check_contains

# Test création avec une classe simple
run_test_step "Créer un test pour une classe utilitaire" \
    "$PROJECT_ROOT/bin/psysh -c \"phpunit:create 'App\\\\Util\\\\Calculator'\"" \
    "✅" \
    check_contains

# Test avec namespace simple
run_test_step "Créer un test avec namespace simple" \
    "$PROJECT_ROOT/bin/psysh -c \"phpunit:create 'MyClass'\"" \
    "✅" \
    check_contains
