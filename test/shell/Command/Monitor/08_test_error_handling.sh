...
test_monitor_error "Index array inexistant" \
...
test_monitor_error "Propriété objet inexistante" \
...
test_monitor_error "Appel méthode sur null" \
...
test_shell_responsiveness "Shell après erreur" \
'$undefined_var = null;' \
'echo 2 + 2' \
'4'
